...
const pages = [{ name: "Editar trámite", href: "#", current: false }];
...
const Editar = () => {
  ...
  const { selectedItem, setSelectedItem, editarTramite } = useTramite();
  const navigate = useNavigate();

  useEffect(() => {
    if (selectedItem.length <= 0) {
      navigate("/dashboard/editar-buscar");
    } else {
      setTipo(selectedItem.tramites[0].valor);
      setPeriodo(selectedItem.tramites[1].valor);
      setEtaSinTransicion(selectedItem.tramites[2].valor);
      setEtaConTransicion(selectedItem.tramites[3].valor);
      setAntesExploracion(selectedItem.tramites[4].valor);
      setExploracionEvaluacionPotencial(selectedItem.tramites[5].valor);
      setExploracionIncorporacionReservas(selectedItem.tramites[6].valor);
      setExploracionProgramaEvaluacion(selectedItem.tramites[7].valor);
      setRevaluacion(selectedItem.tramites[8].valor);
      setProduccionTemprana(selectedItem.tramites[9].valor);
      setAntesDesarrollo(selectedItem.tramites[10].valor);
      setAntesInicioProduccion(selectedItem.tramites[11].valor);
      setProduccionRegular(selectedItem.tramites[12].valor);
      setAbandono(selectedItem.tramites[13].valor);
      setDevolucionArea(selectedItem.tramites[14].valor);
      setRegulacion(selectedItem.tramites[15].valor);
      setRegulacionCorto(selectedItem.tramites[16].valor);
      setArticuloNumeral(selectedItem.tramites[17].valor);
      setDependencias(selectedItem.tramites[18].valor);
      setDetonante(selectedItem.tramites[19].valor);
      setAguasProfundas(selectedItem.tramites[20].valor);
      setAguasSomeras(selectedItem.tramites[21].valor);
      setTerrestres(selectedItem.tramites[22].valor);
      setPresentacion(selectedItem.tramites[23].valor);
      setNombre(selectedItem.tramites[24].valor);
      setNombreConamer(selectedItem.tramites[25].valor);
      setNumeroConamer(selectedItem.tramites[26].valor);
      setNombreFormato(selectedItem.tramites[27].valor);
      setHomoClaveFormatoConamer(selectedItem.tramites[28].valor);
      setPeriodicidad(selectedItem.tramites[29].valor);
      setPlazoPresentar(selectedItem.tramites[30].valor);
      setSujetoRespuestaRadios(selectedItem.tramites[31].valor);
      setPlazoMaximoRespuestaResolucion(selectedItem.tramites[32].valor);
      setMontosDerechosRadios(selectedItem.tramites[33].valor);
      setNombreAprovechamiento(selectedItem.tramites[34].valor);
      setMonto(selectedItem.tramites[35].valor);
      setComentarios(selectedItem.tramites[36].valor);
      setRevision(selectedItem.tramites[37].valor);
      setFechaIngreso(selectedItem.tramites[38].valor);
      setFechaMaximaResolucion(selectedItem.tramites[39].valor);
      setFechaMinimaResolucion(selectedItem.tramites[40].valor);
      setPlazoPrevencion(selectedItem.tramites[41].valor);
      setPlazoRespuestaPrevencion(selectedItem.tramites[42].valor);
      setPlazoRespuesta(selectedItem.tramites[43].valor);
      setPlazoMaximoRespuesta(selectedItem.tramites[44].valor);
      setResolucion(selectedItem.tramites[45].valor);
      setRegulacionLink(selectedItem.tramites[46].valor);
      setPdfReferencia(selectedItem.tramites[47].valor);
      setPdfRequisitos(selectedItem.tramites[48].valor);
    }
  }, []);
  ...
  const handleSumbit = async (e) => {
    ...
    setAlerta({});
    const { msg, error } = await editarTramite(
      _id,
      tipo,
      periodo,
      etaSinTransicion,
              ...
              <form className="" onSubmit={handleSumbit}>
                ...
                <div className="bg-white ">
                  <div className="grid grid-cols-8 gap-3 border-gray-200">
                    ...
                    <div className="col-span-full sm:col-span-3 md:col-span-4 pb-5">
                      ...
                      <select
                        id="tipo"
                        name="tipo"
                        className="mt-2 pl-2 block w-full rounded-md border-0 bg-white py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-inset sm:text-sm sm:leading-6 transition duration-200 ease-in-out text-sm border-slate-200 placeholder:text-slate-400/90 focus:ring-4 focus:ring-[#8A0C35] focus:ring-opacity-20 focus:border-[#8A0C35] focus:border-opacity-40 !box"
                        value={tipo}
                    ...
                    <div className="col-span-full sm:col-span-3 md:col-span-4 pb-5">
                      ...
                      <input
                        ...
                        className="mt-2 pl-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-inset sm:text-sm sm:leading-6 transition duration-200 ease-in-out text-sm border-slate-200 placeholder:text-slate-400/90 focus:ring-4 focus:ring-[#8A0C35] focus:ring-opacity-20 focus:border-[#8A0C35] focus:border-opacity-40 !box"
                  ...
                  <div className="col-span-full sm:col-span-3 md:col-span-4 flex items-center justify-center">
                    <button
                      type="submit"
                      className="transition duration-200 border inline-flex items-center justify-center py-2 px-3 rounded-md font-medium cursor-pointer focus:ring-4 focus:ring-yellow-500 focus:ring-opacity-20 focus-visible:outline-none bg-yellow-600 text-white border-yellow-600 mr-2 shadow-md"
                    >
                      Editar trámite
                    </button>
                  </div>
